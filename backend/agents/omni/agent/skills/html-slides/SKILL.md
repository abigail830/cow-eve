...
4. **`read`** the theme reference from the **sandbox mirror** (same pattern as pptx/docx themes):
   - Ascentium → `/workspace/content-studio/skills/html-slides/references/ascentium-deck.md`
   - Inspire → `/workspace/content-studio/skills/html-slides/references/inspire-deck.md`
   - LRQA → `/workspace/content-studio/skills/html-slides/references/lrqa-deck.md`
...
|----------|-------------------------------|
| Ascentium patterns | `/workspace/content-studio/skills/html-slides/references/ascentium-deck.md` |
| Ascentium PNGs | `/workspace/content-studio/skills/html-slides/assets/ascentium/` |
| Inspire patterns | `/workspace/content-studio/skills/html-slides/references/inspire-deck.md` |
| Inspire PNGs | `/workspace/content-studio/skills/html-slides/assets/inspire/` |
| LRQA patterns | `/workspace/content-studio/skills/html-slides/references/lrqa-deck.md` |
| LRQA PNGs | `/workspace/content-studio/skills/html-slides/assets/lrqa/` |
