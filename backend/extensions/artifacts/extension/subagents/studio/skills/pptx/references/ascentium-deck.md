...
Sandbox path: `/workspace/content-studio/skills/pptx/references/ascentium-deck.md`
...
- Run: `cd /workspace/content-studio && node build-deck.js`.
...
const ASSETS = '/workspace/content-studio/skills/pptx/assets/ascentium';
```
